...
**Note**: If the warp route token already exists, the initialization is skipped. The router for Terra Classic (domain 1325) is automatically enrolled during deployment.
